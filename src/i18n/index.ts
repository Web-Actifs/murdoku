...
void i18next
  ...
  .init({
    ...
    resources: {
      ...
      en: { common: commonEn, clues: cluesEn, decor: decorEn, decorLabels: decorLabelsEn, cases: casesEn, v2cases: v2CasesEn, v3: v3En },
      es: { common: commonEs, clues: cluesEs, decor: decorEs, decorLabels: decorLabelsEs, cases: casesEs, v2cases: v2CasesEs, v3: v3Es },
    },
  })
